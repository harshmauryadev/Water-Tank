...
export const HowItWorks = () => {
  ...
  return (
    <section id="how-it-works" className="py-20 bg-[#F8FAFC] border-y border-slate-200 relative overflow-hidden text-[#0F172A]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Title */}
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-black text-[#0F172A] tracking-tight">
            How It <span className="bg-gradient-to-r from-[#0EA5E9] via-[#0284C7] to-[#14B8A6] bg-clip-text text-transparent">Works</span>
          </h2>
        ...
        <div className="max-w-5xl mx-auto bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-xl">
            ...
            {steps.map((s, index) => {
              ...
              return (
                <React.Fragment key={index}>
                  <div className="flex flex-col items-center text-center p-4 w-full md:w-1/4 rounded-2xl bg-[#F8FAFC] border border-slate-200 hover:border-[#0EA5E9] hover:scale-105 transition-all duration-300 shadow-xs group">
                    ...
                    <span className="text-xs font-extrabold text-[#0F172A] leading-tight">{s.step}</span>
                  </div>

                  {/* Arrow divider */}
                  {index < steps.length - 1 && (
                    <div className="hidden md:flex items-center justify-center text-[#0EA5E9] font-bold">
          ...
          <div className="mt-10 pt-8 border-t border-slate-200 space-y-5">
            <p className="text-sm font-medium text-[#64748B] text-center max-w-2xl mx-auto leading-relaxed">
            ...
            <div className="flex justify-center">
              <a
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-[#0EA5E9] via-[#0284C7] to-[#14B8A6] hover:from-[#0284C7] hover:to-[#14B8A6] text-white text-xs font-extrabold shadow-md shadow-[#0EA5E9]/20 hover:shadow-lg transition-all active:scale-95"
              >
